const strings = {
    ...
    newMediaViewer: ['Старый редактор историй', 'Old story editor', 'Старий редактор історій'],
	newMediaViewerDescription: ['Только для создания истории из ленты', 'Only for creating a story from feed', 'Тільки для створення історії зі стрічки'],
    ...
    additionalFunctionsDescription: ['Старый дизайн сайта от декабря 2017 года - beta<br>Обновите страницу после включения/выключения<br>Временно не поддерживается', 'Old design from December 2017 - beta<br>Refresh the page after turning on/off<br>Temporary unavailable', 'Старий дизайн сайту від грудня 2017 року - beta<br>Оновіть сторінку після увімкнення/вимкнення<br>Тимчасово не підтримується'],
	...
	newMessengerDesignDescription: ['Данной функции потребуется токен от вашей страницы ВК<br>Не пугайтесь при открытии дополнительного окна, мы гарантируем сохранность ваших данных', "This function will require an access token from your VK page<br>Don't be alarmed when an additional window opens, we guarantee the safety of your data", 'Даної функції буде потрібно токен від вашої сторінки ВК<br>Не лякайтеся при відкритті додаткового вікна, ми гарантуємо збереження ваших даних'],
	...
	versionNumber: ['Версия 4.2 Release', 'v. 4.2 Release', 'Версія 4.2 Release'],
