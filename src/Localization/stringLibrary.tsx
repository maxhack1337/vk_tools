...
const strings = {
  ...
  vkToolsError: ["Сообщить об ошибке", "Report a bug", "Повідомити про помилку"],
  vkToolsErrorDesc: ["Напиши нам, если есть вопросы, или ты нашёл ошибку", "Write to us if you have questions or if you found a bug", "Напиши нам, якщо є питання, або ти знайшов помилку"],
  team: ["Команда", "Team", "Команда"],
  contacts: ["Контакты", "Contacts", "Контакти"],
  contactWithUs: ["Связаться с нами", "Contact us", "Зв'язатися з нами"],
  emailUs: ["Напишите нам на почту", "Write to us by email", "Напишіть нам на пошту"],
  ...
  versionNumber: ["Версия 6.5.10 Release", "v. 6.5.10 Release", "Версія 6.5.10 Release"],
