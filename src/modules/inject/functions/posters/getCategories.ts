...
const nameIds: { [key: string]: [string, number[], string[], string[], QueryType] } = {
  picture: [
    typeof vk !== "undefined" && vk?.lang ? getCategoriesLang(vk.lang)[0] : "Картинки",
  ...
  emoji: [
    typeof vk !== "undefined" && vk?.lang ? getCategoriesLang(vk.lang)[1] : "Эмоции",
  ...
  gradient: [
    typeof vk !== "undefined" && vk?.lang ? getCategoriesLang(vk.lang)[2] : "Градиенты",
