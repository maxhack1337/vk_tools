...
const VKEnhancerGraffitiBox = async () => {
  ...
  responseGraffiti.forEach(function (graffiti: { url: string; id: any; owner_id: any }) {
    ...
    var gUrl = graffiti.url.replace(`https://${vk.__domain || "vk.ru"}/`, "");
  ...
  const graffityFileInput = document.querySelector(".vkEnhancerVisuallyHidden") as HTMLInputElement;
