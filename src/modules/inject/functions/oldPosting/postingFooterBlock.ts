...
const postingFooterBlock = (fromOid: any, isUser: boolean, isMyWall: boolean, isSuggested: boolean, onlyOfficial: boolean) => {
  ...
  const label = getPostingFooterLabel(fromOid, isUser, isMyWall, onlyOfficial, isSuggested);
