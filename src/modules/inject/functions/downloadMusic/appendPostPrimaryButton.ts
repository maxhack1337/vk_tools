...
const appendPostPrimaryButton = (url: string, img: string, title: string, elem: HTMLElement) => {
    ...
    button.style.color = "var(--vkui--color_text_primary_invariably)!important";
    const div = create(
        'div',
        {},
        {
...
export default appendPostPrimaryButton;