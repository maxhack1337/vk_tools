...
const toggleShop = () => {
  document.arrive("[class*='CommunityHeader__cover'][data-testid='communityheader_cover']", { existing: true }, () => {
    ...
    if (loc.endsWith(`${vk.__domain || "vk.ru"}/club230675154`) || loc.endsWith(`${vk.__domain || "vk.ru"}/toggle_shop`)) {
      ...
      alertHead.innerHTML = `
            ...
            <div class="toggleShopAlert__text"><b>Внимание! </b>Использование этого функционала может сломать работу сайта ${vk.__domain || "vk.ru"}</div>
        `;
