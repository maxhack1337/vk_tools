        ...
        if (postBottom) {
          ...
          if (!e.querySelector(".vkEnhancerPostDate")) {
            try {
              ...
              if (postData.author != null) {
                xDataPost += `<b style="font-weight:500">${getLang?.("wall_post_author_data_author_title")}</b><br><a class="vkuiLink vkitLink__link--WXYoI vkuiTappable vkuiTappable--hasPointer-none vkuiClickable__resetLinkStyle vkuiClickable__host vkui-focus-visible vkuiRootComponent" href="${
                  postData.author.url
                }">${postData.author.username}</a>`;
              }
              if (postData.publisher != null) {
                let sex = (postData.publisher.sex = postData.publisher.sex === 1 ? 2 : 1);
                xDataPost += `<br><span style="height:6px; display:block;"></span><b style="font-weight:500">${getLang?.(
                  "wall_post_author_data_published_by_title",
                  sex
                )}</b><br><a class="vkuiLink vkitLink__link--WXYoI vkuiTappable vkuiTappable--hasPointer-none vkuiClickable__resetLinkStyle vkuiClickable__host vkui-focus-visible vkuiRootComponent" href="${postData.publisher.url}">${postData.publisher.username}</a>`;
              }
              if (postData.editInfo != null) {
                xDataPost += `<br><span style="height:6px; display:block;"></span><b style="font-weight:500">${getLang?.(
                  "wall_post_author_data_editor_title"
                )}</b><br><div style="display:flex"><a class="vkuiLink vkitLink__link--WXYoI vkuiTappable vkuiTappable--hasPointer-none vkuiClickable__resetLinkStyle vkuiClickable__host vkui-focus-visible vkuiRootComponent" href="${postData.editInfo.url}">${
                  postData.editInfo.username
                }</a><div style="color: var(--vkui--color_text_secondary);">​ ​${postData.editInfo.time}</div></div>`;
              }
              ...
              postDate.innerHTML =
                `
				<a class="vkEnhancerPostDate PostHeaderSubtitle__link" href="/wall` +
                postData.postRaw +
          ...
          if (e.querySelector(".published_sec_quote.PostCopyQuote--redesignV3 .CopyPost__authorLink")) {
            try {
              ...
              postOpen.innerHTML =
                `
				<a class="vkEnhancerPostDate published_by_date" href="/wall` +
          ...
          //Документы
          if (e.querySelector(`[class^="vkitChipAttachment__root"]:has(> a[href^="https://${vk.__domain || "vk.ru"}/doc"])`) && dataAttachments.item.attachments) {
            let allDocs = e.querySelector(`[class^="vkitChipAttachment__root"] > a[href^="https://${vk.__domain || "vk.ru"}/doc"]`);
            let count = 0;
          ...
          if (e.querySelector(`.PostCopyQuote--redesignV3 [class^="vkitChipAttachment__root"]:has(> a[href^="https://${vk.__domain || "vk.ru"}/doc"])`) && dataRepostAttachments.item.attachments) {
            let allDocs = e.querySelector(`.PostCopyQuote--redesignV3 [class^="vkitChipAttachment__root"] > a[href^="https://${vk.__domain || "vk.ru"}/doc"]`);
            let count = 0;
          ...
          if (
            (e.querySelector('.PostCopyQuote--redesignV3 [class^="vkitChipAttachment__root"]:has(> a[href^="http"]:not([class*="vkitLink__secondary"]))') ||
              e.querySelector('.PostCopyQuote--redesignV3 [class^="vkitChipAttachment__root"]:has(> a[href^="/away"]:not([class*="vkitLink__secondary"]))')) &&
            dataRepostAttachments.item.attachments
          ) {
          ...
          //Примари-ссылка
          if (
            (e.querySelector('.vkuiDiv__host > [class^="vkitSnippetAttachment__root"] > a[class^="vkitInteractiveWrapper__root"][href^="https://"]') ||
              e.querySelector('.vkuiDiv__host > [class^="vkitSnippetAttachment__root"] > a[class^="vkitInteractiveWrapper__root"][href^="http://"]') ||
              e.querySelector('.vkuiDiv__host > [class^="vkitSnippetAttachment__root"] > a[class^="vkitInteractiveWrapper__root"][href^="/away"]')) &&
            ...
            if (!allLinks) {
              ...
              if (!allLinks) {
                allLinks = e.querySelector('.vkuiDiv__host > [class^="vkitSnippetAttachment__root"] > a[class^="vkitInteractiveWrapper__root"][href^="http://"]');
              }
            }
          ...
          if (
            (e.querySelector('.PostCopyQuote--redesignV3 .vkuiDiv__host > [class^="vkitSnippetAttachment__root"] > a[class^="vkitInteractiveWrapper__root"][href^="http://"]') ||
              e.querySelector('.PostCopyQuote--redesignV3 .vkuiDiv__host > [class^="vkitSnippetAttachment__root"] > a[class^="vkitInteractiveWrapper__root"][href^="https://"]') ||
              e.querySelector('.PostCopyQuote--redesignV3 .vkuiDiv__host > [class^="vkitSnippetAttachment__root"] > a[class^="vkitInteractiveWrapper__root"][href^="/away"]')) &&
            dataRepostAttachments.item.attachments
          ) {
          ...
          if (e.querySelector('[class^="vkitPrimaryAttachment__root"] :not(.videoplayer_action_button)') && dataAttachments.item.attachments) {
            let allDocs = e.querySelector(`[class^="vkitPrimaryAttachment__root"] [href^="https://${vk.__domain || "vk.ru"}/"]:not(.videoplayer_action_button)`);
          ...
          if (e.querySelector(`.PostCopyQuote--redesignV3 [class^="vkitPrimaryAttachment__root"] [href^="https://${vk.__domain || "vk.ru"}/"]:not(.videoplayer_action_button)`) && dataRepostAttachments.item.attachments) {
            let allDocs = e.querySelector(`.PostCopyQuote--redesignV3 [class^="vkitPrimaryAttachment__root"] [href^="https://${vk.__domain || "vk.ru"}/"]:not(.videoplayer_action_button)`);
