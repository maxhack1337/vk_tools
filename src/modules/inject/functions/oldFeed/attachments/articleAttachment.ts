...
return `
  ...
  <div class="article_snippet__info">
    ...
    <div class="article_snippet__title">${escapeHtml(articleInfo.title)}</div>
    <div class="article_snippet__author">${escapeHtml(articleInfo.owner_name)}<span class=""></span></div>
