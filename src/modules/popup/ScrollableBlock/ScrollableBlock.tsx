    ...
    case "tab2":
      ...
      currentTab = [
        ...
        <div className="vkToolsBlockWithPadding">
          ...
          <CheckBox type={"checkBox"} label={getLang("disableStandaloneCheckOnLoadVideo")} isNew={false} isFire={false} id={"disableStandaloneCheckOnLoadVideo"} shouldReload={true} />
        </div>,
        <div className="vkToolsBlockWithPadding">
