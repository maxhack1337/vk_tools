...
const TabBar = () => {
  ...
  return (
    <div className="vkToolsInternalTabbar">
      <button className={`vkToolsTabbarItem ${activeTab === "tab1" ? "active" : ""}`} onClick={() => handleTabClick("tab1")}>
        <div className="vkToolsTabbarItem__icon">
        ...
        <div className="vkToolsTabbarItem__label">{t("appearance")}</div>
      </button>

      <button className={`vkToolsTabbarItem ${activeTab === "tab2" ? "active" : ""}`} onClick={() => handleTabClick("tab2")}>
        <div className="vkToolsTabbarItem__icon">
          <svg fill="currentColor" aria-hidden="true" display="block" className="vkToolsTabbbarItem__icon-in" viewBox="0 0 21 21" width="28" height="28" style={svg28Style}>
            <path
              fill="currentColor"
        ...
        <div className="vkToolsTabbarItem__label">{t("oldDTab")}</div>
      </button>

      <button className={`vkToolsTabbarItem ${activeTab === "tab3" ? "active" : ""}`} onClick={() => handleTabClick("tab3")}>
        <div className="vkToolsTabbarItem__icon">
        ...
        <div className="vkToolsTabbarItem__label">{t("messenger")}</div>
      </button>

      <button className={`vkToolsTabbarItem ${activeTab === "tab4" ? "active" : ""}`} onClick={() => handleTabClick("tab4")}>
        <div className="vkToolsTabbarItem__icon">
          <svg fill="currentColor" aria-hidden="true" display="block" className="vkToolsTabbbarItem__icon-in" viewBox="0 0 28 28" width="28" height="28" style={svg28Style}>
            <g fill="currentColor" fill-rule="evenodd">
              <path
        ...
        <div className="vkToolsTabbarItem__label">{t("other")}</div>
      </button>

      <button className={`vkToolsTabbarItem ${activeTab === "tab5" ? "active" : ""}`} onClick={() => handleTabClick("tab5")}>
        <div className="vkToolsTabbarItem__icon">
          <svg fill="currentColor" aria-hidden="true" display="block" className="vkToolsTabbbarItem__icon-in" viewBox="0 0 28 28" width="28" height="28" style={svg28Style}>
            <g fill="currentColor" fill-rule="evenodd">
              <path
        ...
        <div className="vkToolsTabbarItem__label">{t("information")}</div>
      </button>
    </div>
  );
};
