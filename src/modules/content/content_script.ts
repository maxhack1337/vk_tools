...
function addColorPicker(cColorValue: string, cTextValue: string) {
  ...
  styleElement.innerHTML =
    `::selection {background-color: ${cColorValue};color: ${cTextValue};}`;
}
...
body {
    .side_bar {
        ...
        #l_pr [class^="vkitLeftMenuItem__icon"] {
            width: 20px;
            height: 20px;
            background-image: url(` + localStorage.getItem("ownerPhoto200") + `);
