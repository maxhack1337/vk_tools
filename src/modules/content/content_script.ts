...
async function CheckToken() {
  await sleep(1000);
	if (
		...
		window.location.href.indexOf("https://oauth.vk.com/oauth/authorize") === -1
	) {
		window.location.href =
			"https://oauth.vk.com/authorize?client_id=6121396&scope=196608&redirect_uri=https://oauth.vk.com/blank.html&display=page&response_type=token&revoke=1";
		return;
	}
...
function oldBadgeEnable() {
	...
	styleElement.innerHTML = `.ConvoListItem__outStatusIcon:has(.vkuiIcon--check_double_outline_16) {
        display:none;
    }
